    ...
    def seed_achievements(self):
        ...
        achievements_data = [
            ...
            },
            {
                ...
                'description': 'Học sinh THPT đạt điểm IELTS cao nhất lên đến 7.5',
            ...
            },
            {
                ...
                'description': 'Học sinh đạt IELTS 5.0-7.5, HSK 3-6, nhiều em nhận học bổng toàn phần các trường đại học quốc tế',
