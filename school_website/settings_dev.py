...
UPLOAD_ALLOWED_EXTENSIONS_BY_TYPE = {
    "image": [".jpg", ".jpeg", ".png", ".gif", ".webp", ".svg"],
    "document": [".pdf", ".doc", ".docx", ".xls", ".xlsx", ".ppt", ".pptx"],
    "other": ALLOWED_UPLOAD_EXTENSIONS,
}
